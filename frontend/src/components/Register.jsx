    ...
    <div>
      <div className="p-4 sm:p-6 md:p-8 md:mx-44 lg:p-10  xl:p-12 xl:mx-44 bg-gray-700 rounded-md shadow-md">
        <form className="formRegister flex flex-col mx-auto">
          ...
          <button
            type="button"
            class="text-white bg-gradient-to-r from-gray-900 via-gray-700 to-gray-800 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
          >
            Submit
          </button>
        </form>

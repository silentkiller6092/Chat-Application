...
const UserChatPage = ({ userName, userImg, usercame }) => {
  // usechatpage(usercame);

  return (
    <div>
      <div className={"w-full bg-gray-900"}>
        <div class="flex-1 justify-between flex flex-col h-screen bg-[#1315184e] ">
          <div class="flex sm:items-center justify-between py-3 bg-[#131518] ">
